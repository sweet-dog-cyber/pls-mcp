...
错误处理:
  ...
  try {
    const TAG_TYPE_MAP: Record<string, number> = { 'UWB': 0, 'Bluetooth': 1, 'GPS': 2, 'UWB+GPS': 3, '惯性导航': 4 };
    const TAG_TYPE_REV: Record<number, string> = { 0: 'UWB', 1: 'Bluetooth', 2: 'GPS', 3: 'UWB+GPS', 4: '惯性导航' };
