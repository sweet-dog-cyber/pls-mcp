...
function validateConfig() {
  ...
  if (!appConfig.mysql.user) missing.push('PLS_MYSQL_USER');
  if (!appConfig.mysql.password) missing.push('PLS_MYSQL_PASSWORD');
  if (!appConfig.mysql.database) missing.push('PLS_MYSQL_DATABASE');
